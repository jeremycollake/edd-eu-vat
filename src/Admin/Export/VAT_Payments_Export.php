 ...
 */
class VAT_Payments_Export implements Registerable, Service {
	...
	public function __construct( $template_path ) {
		$this->batch_class_path = __DIR__ . '/Batch_VAT_Payments_Export.php';
	...
	public function include_vat_payments_batch_processer( $class ) {
		if ( 'Batch_VAT_Payments_Export' === $class ) {
	...
	public function include_meta_box() {
		include $this->template_path . 'export-vat-payments.php';
	}
