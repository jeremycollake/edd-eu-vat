 ...
 */
namespace Barn2\Plugin\EDD_VAT\Dependencies\Setup_Wizard\Steps;
...
class Cross_Selling extends Step
{
    ...
    public function __construct()
    {
        ...
        $this->set_description(esc_html__('Enhance your site with these fantastic plugins from Barn2.', 'edd-eu-vat'));
    }
    /**
     * {@inheritdoc}
     */
