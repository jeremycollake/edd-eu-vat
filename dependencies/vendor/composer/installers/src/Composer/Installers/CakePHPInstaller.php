...
use Barn2\Plugin\EDD_VAT\Dependencies\Composer\Semver\Constraint\Constraint;
class CakePHPInstaller extends BaseInstaller
{
    ...
    public function inflectPackageVars($vars)
    {
        ...
        foreach ($nameParts as &$value) {
            $value = \strtolower(\preg_replace('/(?<=\\w)([A-Z])/', 'Barn2\\Plugin\\EDD_VAT\\Dependencies\\_\\1', $value));
